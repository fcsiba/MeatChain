...
public class PackagingForm extends BaseActivity {

    // XML Views
    TextView valueType, valueGender, valueAge, valueWeight;
    TextView valueDateOfSlaughter;
    RadioGroup radioGroup_MeatPart, radioGroup_MeatType;
    private EditText FieldDOP;
    private Button submitButton;

    //Class Variables
    private static final String TAG = PackagingForm.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_packaging_form);
    ...
    private void initVariables() {
        ...
        radioGroup_MeatPart = findViewById(R.id.radioGroup_MeatPart);
        radioGroup_MeatType = findViewById(R.id.radioGroup_MeatType);
        FieldDOP = findViewById(R.id.FieldDOP);
    ...
    public void initClickListeners(){
        ...
        //Opens Date Picker
        FieldDOP.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onClickSubmitButton() {
        ...
        int selectedId = radioGroup_MeatPart.getCheckedRadioButtonId();
        RadioButton radioButton = findViewById(selectedId);
        String MeatPart = String.valueOf(radioButton.getText());

        int selectedId2 = radioGroup_MeatType.getCheckedRadioButtonId();
        RadioButton radioButton2 = findViewById(selectedId2);
        String MeatType = String.valueOf(radioButton2.getText());

        String DOP = FieldDOP.getText().toString();


        // check if any field is empty
        if (!MeatPart.isEmpty() && !MeatType.isEmpty() && !DOP.isEmpty() ) {
            // update product data in products node

            Constants.myProduct.setMeatPart(MeatPart);
            Constants.myProduct.setMeatType(MeatType);
            Constants.myProduct.setPackagingDate(DOP);
            Constants.myProduct.setExpiryDate(ExpiryDate);
            Constants.myProduct.setProcessStatus(2);
            Constants.myProduct.setInfo2Id(Constants.myUser.getUserId());
            Constants.myProduct.setInfo2Time(System.currentTimeMillis() + "");
            ...
            FirebaseDatabase.getInstance().getReference(Constants.PRODUCTS_NODE).child(Constants.myProduct.getProductId())
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            startActivity(new Intent(PackagingForm.this, ProductInfoActivity.class));
                            finish();
                        }
    ...
    private DatePickerDialog.OnDateSetListener datePickerListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker datePicker, int year, int month, int day) {
            ...
            FieldDOP.setText(formatToDisplay);

            c.add(Calendar.MONTH, 1);
            ExpiryDate = new SimpleDateFormat("dd-MM-yyyy").format(c.getTime());
        }
    };
}
